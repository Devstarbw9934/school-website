<?php 
		...
		$query = "DELETE FROM user WHERE id='".$id."' and role!='admin'";		
...
<?php
					while($row = mysqli_fetch_array($result)){   //Creates a loop to loop through results
							...
							<a class='btn btn-primary' href='new_user.php?id=" .$row['id'] . "&tab=1'><i class='fa fa-plus edit' data-toggle='tooltip'></i>Edit</a>
					...
					while($row = mysqli_fetch_array($reslt)){   //Creates a loop to loop through results
							...
							<td><div class='field-actions'><div class='btn-group'>
							<form action='users.php' method='post'>
							<a class='btn btn-primary' href='new_user.php?id=" .$row['id'] . "&tab=2'><i class='fa fa-plus edit' data-toggle='tooltip'></i>Edit</a>

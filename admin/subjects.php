...
<h3>Trainings</h3>
<p>Trainings are the parts into which learning can be divided. Each lesson related to a subject only.</p>
<hr />
...
<a class="btn btn-success" href="new_subject.php"><i class="fa fa-plus add" data-toggle="tooltip"></i>New Training</a></div>
...
<?php
					while($row = mysqli_fetch_array($result)){   //Creates a loop to loop through results
							...
							<a class='btn btn-primary' href='new_subject.php?id=" .$row['id'] . "'><i class='fa fa-plus edit' data-toggle='tooltip'></i>Edit</a>

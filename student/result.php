<?php
 ...
 include("includes/header.php"); 
		...
		WHERE results.class='$class' OR results.subject='$subj' OR results.sid='$std'"; //You don't need a ; like you do in SQL
		...
		$sr =$_SESSION["regno"]??0;
		$query = "SELECT subject FROM tsubject where teacher='".$sr."'"; //You don't need a ; like you do in SQL

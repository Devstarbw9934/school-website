...
<h3>Exams</h3><p>Below is the list of the exams created in this account.</p>
...
<?php
					while($row = mysqli_fetch_array($result)){   //Creates a loop to loop through results
							...
							echo "</td><td>" . $row['class'] . "</td>
							<td><div class='field-actions'><div class='btn-group'>
							<form action='exams.php' method='post'>
							<a class='btn btn-primary' href='new_exam.php?id=" .$row['id'] . "'><i class='fa fa-plus edit' data-toggle='tooltip'></i>Edit</a>

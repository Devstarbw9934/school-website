...
<button aria-label="Close" class="close" data-dismiss="alert" type="button"><span aria-hidden="true">×</span></button>Exam step 2 updated successfully!</div>
...
<?php
					while($row = mysqli_fetch_array($reslt)){   //Creates a loop to loop through results
							echo "<tr><td>" . $row['question'] . "</td><td>" . $row['marks'] . "</td><td>";
...
<thead><tr><th>Question</th><th>Training</th><th>Mark</th><th>Actions</th></tr></thead>
<tbody>

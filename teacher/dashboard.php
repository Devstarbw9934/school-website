<?php include("includes/header.php");
		...
		?>
<meta content="width=device-width, initial-scale=0.5, maximum-scale=1.0, user-scalable=yes" name="viewport" /><div class="content-main"><div class="container-fluid"><div class="row"><div class="col-sm-12 col-md-12">
<h3>Dashboard</h3><hr />
<p>Hello <b><?php echo $id;?></b>, Welcome to 
<b>STC مركز التدريب الذاتي </b> portal. You can use this interface to manage your Exams and the rest of your account.</p><hr />
<div class="row">
